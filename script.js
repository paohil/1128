document.addEventListener("DOMContentLoaded", () => {
    ...
    // Journey Data
    const months = [
      { title: "0th/12th November 2023", image: "./images/1.jpeg", caption: "Yie" },
      { title: "1st/12th December 2023", image: "./images/2.jpeg", caption: "ganda mo dito (sa lahat naman)" },
      { title: "2nd/12th January 2024", image: "./images/3.jpeg", caption: "FIRST hello natin (i think)" },
      { title: "3rd/12th February 2024", image: "./images/4.jpeg", caption: "kunware pa nag wwork" },
      { title: "4th/12th March 2024", image: "./images/5.jpeg", caption: "tanggal angas ko pero maganda ka dito e" },
      { title: "5th/12th April 2024", image: "./images/6.jpeg", caption: "FIRST kiss (hi tita)" },
      { title: "6th/12th May 2024", image: "./images/7.jpeg", caption: "last day of school yehey" },
      { title: "7th/12th June 2024", image: "./images/8.jpeg", caption: "shopping day pero ako lang gumagastos" },
      { title: "8th/12th July 2024", image: "./images/9.jpeg", caption: "1 magna cum laude and 1 valedictorian" },
      { title: "9th/12th August 2024", image: "./images/10.jpeg", caption: "name tag says it all" },
      { title: "10th/12th September 2024", image: "./images/11.jpeg", caption: "sports: bowling added to resume" },
      { title: "11th/12th October 2024", image: "./images/12.jpeg", caption: "willing maging sapatos for u" },
      { title: "12th/12th November 2024", image: "./images/13.jpg", caption: "???????" },
    ];
    ...
    function showMonth() {
      ...
      if (currentMonth === months.length - 1) {
        nextMonth.textContent = "CLICK ME ♡(∩˃o˂∩)";
      } else {
        nextMonth.textContent = "(づ๑•ᴗ•๑)づ♡ Next";
      }
...
function startHangmanGame() {
    ...
    // Set title styles
    title.textContent = "🕵️‍♂️ GUESS WHERE WE EATINNN 🕵️‍♀️";
